<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminSite.master" AutoEventWireup="true" Inherits="Pages_Login" Codebehind="Login.aspx.cs" %>
            ...
            <div class="accountInfo">
                <fieldset class="login">
                    ...
                    <p>
                        ...
                        <asp:Label ID="RememberMeLabel" runat="server" AssociatedControlID="RememberMe" CssClass="inline">Ghi nhớ đăng nhập</asp:Label>
                    </p>
                </fieldset>
