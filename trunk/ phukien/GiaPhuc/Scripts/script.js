    ...
    $.lofSidernews.fn.extend({
        startUp: function(obj, wrapper) {
            ...
            this.navigatorItems.each(function(index, item) {
                ...
                $(item).css({ 'height': self.settings.navigatorHeight, 'width': self.settings.navigatorWidth });
            });
        ...
        onComplete: function() {
            setTimeout(function() { $('.preload').fadeOut(900, function() { $('.preload').remove(); }); }, 400);
            this.startUp();
        },
