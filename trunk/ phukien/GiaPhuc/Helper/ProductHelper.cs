...
namespace GiaPhuc.Helper
{
    ...
    {
        public static string GetProductItemLayout(int itemPerRow, string code, string name, string url, string originUrl, string imgSrc,
            string price, string discountPrice = "")
        {
            ...
            builder.AppendFormat("<a href=\"{2}\"><img data-src=\"{0}\" src=\"/images/ajax-loader.gif\" alt=\"{1}\" title=\"{1}\" /></a>", "/hinh-anh/phu-kien-nho/" + originUrl, name, url);
